...
import com.dr_complex.double_edged_enchantments.entity.projectiles.WoodenSpearEntity;
        ...
        if (user instanceof PlayerEntity player) {
            ...
            if (i < draw_time) {
                ...
                if(world instanceof ServerWorld serverWorld){
                    ...
                    WoodenSpearEntity woodenSpear = WoodenSpearEntity.spawnWithVelocity(WoodenSpearEntity::new,serverWorld, stack, player, roll, power, spread);
