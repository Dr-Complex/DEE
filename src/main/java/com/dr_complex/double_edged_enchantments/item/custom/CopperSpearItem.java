...
import com.dr_complex.double_edged_enchantments.entity.projectiles.CopperSpearEntity;
        ...
        if (user instanceof PlayerEntity player) {
            ...
            if (i < draw_time) {
                ...
                if(world instanceof ServerWorld serverWorld){
                    ...
                    CopperSpearEntity copperSpear = CopperSpearEntity.spawnWithVelocity(CopperSpearEntity::new,serverWorld, stack, player, roll, power, spread);
