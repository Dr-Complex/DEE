...
import com.dr_complex.double_edged_enchantments.entity.projectiles.IronSpearEntity;
...
public class IronSpearItem extends Item implements ProjectileItem {
    ...
    private static final float roll = 0.5f;
        ...
        if (user instanceof PlayerEntity player) {
            ...
            if (i < draw_time) {
                ...
                if(world instanceof ServerWorld serverWorld){
                    ...
                    IronSpearEntity ironSpear = IronSpearEntity.spawnWithVelocity(IronSpearEntity::new,serverWorld, stack, player, roll, power, spread);
