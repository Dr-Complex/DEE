...
import com.dr_complex.double_edged_enchantments.entity.projectiles.JettatiumSpearEntity;
...
public class JettatiumSpearItem extends Item implements ProjectileItem {
    ...
    public JettatiumSpearItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        JettatiumSpearEntity spearEntity = new JettatiumSpearEntity(pos.getX(),pos.getY(),pos.getZ(),world,stack.copyWithCount(1),null);
        ...
        if (user instanceof PlayerEntity player) {
            ...
            if (i < draw_time) {
                ...
                if(world instanceof ServerWorld serverWorld){
                    ...
                    JettatiumSpearEntity copperSpear = JettatiumSpearEntity.spawnWithVelocity(JettatiumSpearEntity::new,serverWorld, stack, player, roll, power, spread);
